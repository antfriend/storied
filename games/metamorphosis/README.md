# Metamorphosis — boxed game

Print-and-play artifacts for **Metamorphosis**, generated from the Feelings TTDB and the
game's rules. Regenerate with:

```bash
cd tools/feelings_cards && python generate_feelings_cards.py --deck metamorphosis
```

## Contents
- **Metamorphosis_Deck.pdf** — the card deck: 6 cards across 1 front page(s),
  each followed by a matching card back for **duplex** printing.
- **Metamorphosis_Rules.pdf** — the full rules booklet.
- **README.md** — this file.

## Printing the deck
- Print **Metamorphosis_Deck.pdf** at **100% / actual size** (no "fit to page") on US Letter.
